...
?>
<div class="crud-form" id="crud-form" data-unique-hash="<?php echo $unique_hash; ?>">
    <div class="container gc-container">
        <div class="row">
            <div class="col-md-12">
                <div class="table-label" style="height: 50px;background: #cdf1e0;">
                    <div class="floatL l5" style="margin-top:10px !important">
                    <font size=3><b><i class="fa fa-plus"></i>  <?php echo $this->l('form_add'); ?> <?php echo $subject?></b></font>
                ...
                <div class="form-container table-container">
                        <?php echo form_open( $insert_url, 'method="post" id="crudForm"  enctype="multipart/form-data" class="form-horizontal"'); ?>
                            ...
                            <div class='small-loading hidden' style='display:none' id='FormLoading'><?php echo $this->l('form_insert_loading'); ?></div>
