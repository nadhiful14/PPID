            ...
            <div class="row">
                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                    <div class="breadcome-heading">
                        <h4><b>Selamat Datang <?php echo $this->session->userdata('skpi_nama') ?></b></h4>
                    </div>
                </div>
        ...
        <div class="analytics-sparkle-line reso-mg-b-30">
            <div class="analytics-content">
                ...
                <div class="progress m-b-0">
                    <div class="progress-bar progress-bar-success" role="progressbar" aria-valuenow="50" aria-valuemin="0" aria-valuemax="100" style="width:100%;"> <span class="sr-only">10% Complete</span> </div>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="col-lg-4 col-md-12 col-sm-12 col-xs-12" style="margin-bottom:20px;">
                <div class="single-cards-item">
                    <div class="single-product-image">
                        <a href="#"><img src="<?php echo base_url('assets/template') ?>/img/product/profile-bg.jpg" alt=""></a>
                    </div>
                    <div class="single-product-text">
                        <img src="<?php echo base_url() ?>/assets/uploads/files/default.png" alt="">
                        <h4><a class="cards-hd-dn" href="#"><?php echo $this->session->userdata('skpi_nama') ?></a></h4>
                        <h5><?php echo @$level->nama ?></h5>
                        <!-- <p class="ctn-cards">Point Yang Telah Dikumpulkan</p> -->
                        <div class="row">
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <div class="cards-dtn">
                                    <h3><span class="counter"><?php echo @$point ?></span></h3>
                                    <p>Point</p>
                                </div>
                            </div>
