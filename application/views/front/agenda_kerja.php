                ...
                <div class="full">
                    <div class="title-holder">
                        <div class="title-holder-cell text-left">
                            <h1 class="page-title">Agenda Kerja DPRD</h1>
                            <ol class="breadcrumb">
                                <li><a href="<?php echo site_url() ?>">Home</a></li>
                                <li class="active">Agenda Kerja DPRD</li>
                            </ol>
                        </div>
                    </div>
                </div>
                ...
                <div class="full">
                    <div class="tab_bar_section" style="margin-top:0px">
                        <ul class="nav nav-tabs" role="tablist">
                            <?php foreach ($agenda_kerja as $key => $laporan) {
                                $isi = $laporan['agenda_kerja'];
                                $tahun = $laporan['tahun'];
                            ?>
                        ...
                        <div class="tab-content" style="padding:0px ;">
                            ...
                            ?>
                                ...
                                <div id="<?php echo $tahun ?>" class="tab-pane table table-responsive <?php echo ($key == 0) ? 'active' : '' ?>">
