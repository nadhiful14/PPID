                ...
                <div class="full">
                    <div class="title-holder">
                        <div class="title-holder-cell text-left">
                            <h1 class="page-title">Komisi-Komisi</h1>
                            <ol class="breadcrumb">
                                <li><a href="<?php echo site_url() ?>">Home</a></li>
                                <li class="active">Komisi-Komisi</li>
                            </ol>
                        </div>
                    </div>
                </div>
        ...
        <div class="row">
            <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12 pull-right">
                <div class="full">
                    ...
                    foreach ($komisi_komisi as $berita) {
                        $judul = $berita['judul'];
                        $slug = $berita['slug'];
                        $isi = $berita['isi'];
                ...
                <div class="side_bar">
                    <div class="side_bar_blog">
                        ...
                        <div class="side_bar_search">
                            ...
                            <!-- <form action="<?php echo base_url('Front/listBerita') ?>" method="post">
